...
export const validationSchema = Joi.object({
	...
	API_AWS_ENDPOINT: Joi.string().optional(),
	API_AWS_BUCKET_NAME: Joi.string().required(),
	API_AWS_ACCESS_KEY_ID: Joi.string().required(),
	API_AWS_SECRET_ACCESS_KEY: Joi.string().required(),
	API_AWS_REGION: Joi.string().required(),
